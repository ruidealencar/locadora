...
CREATE TABLE TB_LOCACOES (
  ...
  LOC_PAGAMENTO_CODIGO INT UNSIGNED NOT NULL,
  ...
  FOREIGN KEY (LOC_PAGAMENTO_CODIGO) REFERENCES TB_FORMA_PAGAMENTO (PAGAMENTO_CODIGO)
) ENGINE = InnoDB;
...
SELECT LOC_CODIGO, LOC_DATA_LOCACAO, LOC_DATA_ENTREGA, CAR_MODELO, CLI_NOME, LOC_PAGAMENTO_CODIGO, FUN_FUNCIONARIO
FROM TB_LOCACOES
...
INNER JOIN TB_FORMA_PAGAMENTO on LOC_PAGAMENTO_CODICO = PAGAMENTO_CODIGO