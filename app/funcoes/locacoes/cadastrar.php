<?php
    ...
    $comando = $conexao->prepare("INSERT INTO TB_LOCACOES (LOC_DATA_LOCACAO, LOC_ODOMETRO_INICIAL, LOC_ODOMETRO_FINAL, LOC_CAR_CODIGO, LOC_CLI_CODIGO, LOC_PAGAMENTO_CODIGO, LOC_FUN_CODIGO) VALUES ('{$loc_data_locacao}', {$loc_odometro_inicial}, 0, {$loc_car_codigo}, {$loc_cli_codigo}, {$pagamento_pagamento}, {$loc_fun_codigo})");
    $comando->execute();
