        ...
        <div class="card-body">
            <div class="row">
                <div class="col">
                    ...
                    <input type="text" value="" class="form-control" name="cli_nome" required="required" autofocus> 
                </div>
            </div>
            <div class="row">
                <div class="col">
                    <label for="cli_documento">Documento</label>
                    <input type="text" value="" class="form-control" name="cli_documento" required="required"> 
                </div>
            </div>
            <div class="row">
                <div class="col">
                    <label for="cli_email">Email</label>
                    <input type="text" value="" class="form-control" name="cli_email" required="required"> 
                </div>
            </div>
            <div class="row">
                <div class="col">
                    <label for="cli_endereco">Endereço</label>
                    <input type="text" value="" class="form-control" name="cli_endereco" required="required"> 
                </div>
            </div>
            <div class="row">
                <div class="col">
